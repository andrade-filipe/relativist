...
**Last updated:** 2026-04-25 (Phase B Wave 3 closed in commit `5c6d8b6`. Wave 2 closed in commit `ba846ad`. Wave 1 closed in commit `4fb77bc`. v2 Pre-DEV Spec Pipeline CLOSED across Waves 1+2 in commits `ec680e4`, `b66f758`, `bbd976e`, `508e595`, `131ca26`. Strategic decision logged: Tier 2 + Tier 3 DEV next; Tier 4 + Tier 5 deferred until after Tier 2+3 ship.)
**Updated by:** **Phase B Wave 3 closed (TASK-0419, 0422).** Implemented `JoinRequest` handler in `accept_workers` with NF-009 version shape; refactored coordinator main loop to `tokio::select!` 4-arm pattern; added `self_worker.rs` for in-process reduction. Test floor: 1256 default / 1299 zero-copy (parity preserved). v1 floor (690) preserved.
