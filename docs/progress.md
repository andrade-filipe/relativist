...
**Last updated:** 2026-04-25 (Phase B Wave 1 closed in commit `4fb77bc`. v2 Pre-DEV Spec Pipeline CLOSED across Waves 1+2 in commits `ec680e4`, `b66f758`, `bbd976e`, `508e595`, `131ca26`. Strategic decision logged: Tier 2 + Tier 3 DEV next; Tier 4 + Tier 5 deferred until after Tier 2+3 ship.)
**Updated by:** **Phase B Wave 1 closed (TASK-0415, 0417, 0421, 0426).** Extended `GridConfig` with 9 elastic fields and `ExecutionMode` matrix (M0); bumped `PROTOCOL_VERSION` 3 -> 4; implemented `compute_round_id_ranges` for dynamic `K_eff` membership; decoupled `TimerKind` into a normative enum in `protocol::timers` (NF-008). Test deltas: 1230 -> 1242 default / 1273 -> 1285 zero-copy (+12 each). v1 floor (690) preserved.
