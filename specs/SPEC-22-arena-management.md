...
**Status:** Reviewed v2.2 — R10b/R10c trigger broadened per SPEC-21 §3.8 A6 (`delta_mode` → `(delta_mode || streaming_active)`); §3.8 A11 added per D-011 Phase A (SPEC-19 R35a — `CompactSubnet` wire encoding of `free_list`; closes QA-D009-001)
